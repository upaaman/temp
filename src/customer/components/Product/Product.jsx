...
export default function Product() {
    ...
    const handleRadioButtonFilters = (e,sectionId) => {
        const searchParams = new URLSearchParams(location.search);
    ...
    return (
        <div className="bg-white">
            <div>
                ...
                <main className="mx-auto  px-4 sm:px-6 lg:px-[2.7rem]">
                        ...
                        <div className="grid grid-cols-1 gap-x-8 gap-y-10 lg:grid-cols-5">
                            ...
                            <div>
                                <div className='flex justify-between items-center py-7'>
                                    <h1 className='text-xl font-bold opacity-50'>Filters</h1>
                                    <FilterListIcon />
                                </div>
                                                            ...
                                                            <FormControl>
                                                                ...
                                                                >
                                                                    {section.options.map((option, optionIdx) => (
                                                                        ...
                                                                        <>
                                                                            <FormControlLabel
                                                                            onChange={(e)=>handleRadioButtonFilters(e,section.id)}
                                                                                value={option.value}
                                                                                control={<Radio />}
                                                                                label={option.label} />
                                                                        </>
