        ...
        <div className="bg-white">
            <div className="pt-6">
                ...
                <section className='grid grid-cols-1 lg:grid-cols-2 gap-x-2 gap-y-10 px-4 pt-10'>
                    ...
                    <div className="lg:col-span-1 max-w-2xl px-4 pb-16 sm:px-16 lg:max-w-7xl lg:px-8 lg:pb-24">
                        <div className="lg:col-span-2">
                            ...
                            <h1 className='text-lg lg:text-xl text-gray-900 opacity-60 pt-1'>This is the name of the product</h1>
                        </div>
                        ...
                        <div className="mt-4 lg:row-span-3 lg:mt-0">
                            ...
                            <div className="mt-6">
                                <div className="flex items-center space-x-3">
                                    ...
                                    <p className='ml-3 text-sm font-medium text-indigo-600 hover:text-indigo-500'>34 Reviews</p>
                                </div>
                            </div>
                        ...
                        <Grid container spacing={7}>
                            ...
                            <Grid xs={5}>
                                ...
                                <div className=' flex items-center space-x-3'>
                                    ...
                                    <p className='opacity-60'>35 Rating</p>
                                </div>
                                ...
                                <Box className="space-y-3 mt-5">
                                    <Grid container alignItems="center" gap={2}>
                                        ...
                                        <Grid xs={7}>
                                            <LinearProgress sx={{ bgcolor: "#d0d0d0", borderRadius: 4, height: 7 }}
                                                variant='determinate' value={55} color='success' />
                                    ...
                                    <Grid container alignItems="center" gap={2}>
                                        ...
                                        <Grid xs={7}>
                                            <LinearProgress sx={{ bgcolor: "#d0d0d0", borderRadius: 4, height: 7 }}
                                                variant='determinate' value={5} color='success' />
                ...
                <section className=' space-y-10'>
                    <h1 className='  text-xl font-bold mx-[7%] '>
                        Similar Products
                    </h1>
                    <div className='flex flex-wrap space-y-8 space-x-8 justify-center'>

                        {womenKurtha.map((item) => <HomeSectionCard product={item} />)}
                    </div>
                </section>
